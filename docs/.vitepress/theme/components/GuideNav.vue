...
const sections: readonly NavSection[] = [
  ...
  { id: 'transactions', label: 'Transactions', branches: [{ id: 'receive', label: 'Receive', chapterIds: ['receive'], landingId: 'receive-guide' }, { id: 'signing', label: 'Signing', chapterIds: ['sign-psbt'] }] },
...
<template>
  <Teleport to=".ss-doc-nav-mobile-controls">
