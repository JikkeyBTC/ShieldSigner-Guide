...
description: Prepare a new SeedKeeper card safely
---
...
3. Confirm the card identifier and test a harmless operation.

Never reuse a PIN from another service or send it through chat or remote support.
