...
JavaCard is a constrained smart-card platform that runs security applets and keeps sensitive operations inside the card boundary.<br> It is not a general-purpose desktop operating system.
