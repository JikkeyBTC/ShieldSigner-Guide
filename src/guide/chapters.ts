...
export const chapters = [
  ...
  { id: 'javacard', label: 'JavaCard란?', href: '/seedkeeper/javacard/', group: 'SeedKeeper', order: 4 },
  { id: 'what-is-seedkeeper', label: 'SeedKeeper란?', href: '/seedkeeper/what-is-seedkeeper/', group: 'SeedKeeper', order: 5 },
  { id: 'seedkeeper-initialize', label: '카드 초기화와 PIN', href: '/seedkeeper/initialize/', group: 'SeedKeeper', order: 7 },
  { id: 'seedkeeper-save', label: '시드를 카드에 저장하기', href: '/seedkeeper/save/', group: 'SeedKeeper', order: 8 },
  { id: 'seedkeeper-load', label: '카드에서 시드 불러오기', href: '/seedkeeper/load/', group: 'SeedKeeper', order: 9 },
